...
export default function AboutMe() {
  ...
  return (
    <section id="about-me" className="section-container" style={{ maxWidth: '1100px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '3rem', alignItems: 'center' }} className="about-me-grid">
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
            ...
            <span style={{ fontSize: 'clamp(0.9rem, 2vw, 1.125rem)', color: 'var(--text-main)', fontFamily: 'var(--font-heading)', letterSpacing: '1px' }}>DEGREE: MCA</span>
          </div>

          <p style={{ color: 'var(--text-muted)', fontSize: 'clamp(0.95rem, 2vw, 1.05rem)', lineHeight: 1.7, marginTop: '1rem' }}>
      ...
      <style>{`
        ...
        @media (min-width: 850px) {
          .about-me-grid { grid-template-columns: 1.2fr 0.8fr; }
        }
